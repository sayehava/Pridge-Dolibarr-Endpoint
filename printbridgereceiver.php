 ...
 *
 * Not a normal Dolibarr page: called server-to-server by PrintBridgeClient (and, once a
...
if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
    ...
    echo "Method not allowed - PrintBridge receiver only accepts POST";
    exit;
}
...
dol_syslog("printbridgereceiver: received ".strlen($data)." byte(s) for profile '".$profileref."'");
